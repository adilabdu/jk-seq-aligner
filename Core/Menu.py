...
if __name__ == "__main__":  # __main__
    ...
    # Swich-case Re sequencing- Reference sequence compare to [SRA (Seqeunce Read Arcaive)] or [Single query]
    # SRA (num_1), Single query (num_2)
    ...
    # Reference sequence compare to [SRA (Seqeunce Read Arcaive)] or [Single query]
    # Input the reference_name.fasta
    print("\nPlease input reference data set ([sequence_name].fasta)")
